...
""")
st.page_link("pages/2_Recipes.py", label="Go to Recipes →")
...
""")
st.page_link("pages/3_Suggestions.py", label="Go to Suggestions →")
...
""")
st.page_link("pages/5_Shopping_List.py", label="Go to Shopping List →")
